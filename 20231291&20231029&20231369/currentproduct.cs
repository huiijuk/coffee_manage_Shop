...
namespace _20231291_20231029_20231369
{
    public partial class currentproduct: Form
    {
        ...
        {
            if (txtID.Text == "" && txtname.Text == "" && txtprice.Text == "" && txtstatus.Text == "" && txtstock.Text == "" && comboBox1.Text == "")
            {
            ...
            {
                conn.Open();
                string add = "INSERT INTO tb_product VALUES('" + txtID.Text + "','" + txtname.Text + "','"+comboBox1.Text+"','" + txtstock.Text + "','" + txtprice.Text + "','" + txtstatus.Text + "', Now())";
        ...
        {
            conn.Open();
            string Delete = "DELETE FROM tb_product WHERE ProductID = '" + txtID.Text + "'";
